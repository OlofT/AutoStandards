...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //[[AutoStandards sharedInstance] navigationBarAppearance:nav.navigationBar];
    
    self.window = [[UIWindow alloc] init];
    
    //fix frame bugs in older versions
    ...
    //[[AutoStandards sharedInstance] color:AutoColorMainViewBackground forView:self.window method:AutoSetValueBackgroundColor];
